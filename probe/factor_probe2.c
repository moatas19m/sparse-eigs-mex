...
int main(int argc, char**argv){
    ...
    umfpack_dl_defaults(ctl); if(getenv("SYMSTRAT")) ctl[UMFPACK_STRATEGY]=UMFPACK_STRATEGY_SYMMETRIC;
    ...
    c.nmethods = 1; c.method[0].ordering = getenv("USE_AMD")? CHOLMOD_AMD : CHOLMOD_METIS; c.postorder = 1;
    cholmod_sparse As;
